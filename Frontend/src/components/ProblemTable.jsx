...
function ProblemTable({ problems }) {
  ...
  const [problemsPerPage, setProblemsPerPage] = React.useState(5)
  ...
  const paginatedProblems = useMemo(() => {
    return filteredProblems.slice(
      (currentPage - 1) * problemsPerPage,      // 0 * 5 = 0 (Starting index)
      currentPage * problemsPerPage             // 1 * 5 = 5 (Ending index)
    );
  ...
  const handleAddToPlaylist = async (id) => {
    console.log("Add problem with id", id)
  }
  ...
  return (
    <div className="w-full max-w-6xl mx-auto mt-10">
      ...
      {/* Search, Difficulty, Tag, Problems Per Page Filters */}
      <div className="flex items-center mb-6 gap-4">
        ...
        <select
          ...
          onChange={(e) => setProblemsPerPage(e.target.value)}
        >
          <option value="5">5 Problems/Page</option>
          <option value="10">10 Problems/Page</option>
          <option value="20">20 Problems/Page</option>
        </select>
      </div>
